        ...
        <div className="h-1/3">
          ...
          >
            <div className="h-full flex flex-col justify-between">
              <div className="text-white gap-2 flex flex-col"></div>
            </div>
          </CustomizedCard>
        </div>
        <div className="h-2/3">
      ...
      <div className="w-2/3 h-full gap-6 flex flex-col">
        <div className="h-[calc(50%)]">
          <CustomizedCard styleClass="border border-[#D5D5D7] border-[1px] rounded-2xl">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-sm font-medium">Biểu đồ phân tích lợi nhuận</h3>
            </div>
          </CustomizedCard>
        </div>
        <div className="h-[calc(50%-12px)]">
          <CustomizedCard styleClass="border-none bg-gradient-to-b from-[#555555] to-[#353535] rounded-2xl">
            <div className="flex justify-between items-center mb-4 ">
              <h3 className="text-sm text-white">Lịch sử yêu cầu phê duyệt yêu cầu thêm sản phẩm</h3>
            </div>
          </CustomizedCard>
        </div>
      </div>
