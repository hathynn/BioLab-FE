      ...
      <div className="flex flex-col items-center p-6 min-h-screen">
        <div className="bg-white p-6 rounded-2xl w-full max-w-md">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-500">Thành công thanh toán 150$!</p>
          </div>
  
          <div className="mt-6 bg-gray-50 p-4 rounded-xl shadow-inner">
            <h3 className="font-semibold text-gray-700">Phương thức thanh toán</h3>
            <div className="mt-2 space-y-2 text-sm text-gray-600">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">$150.45</span>
              </div>
